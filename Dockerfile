...
RUN apt-get -qq update && \
    ...
    apt-get -qq install pkg-config pandoc 
#    g++-multilib gcc-multilib


RUN apt-get clean && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*

# Support for i386 / Intel 32 bit linux builds pulled from
# https://github.com/kohanyirobert/crossbuild-i386-linux-gnu/blob/master/Dockerfile
...
RUN mkdir -p /home/builder/dfu-utils

WORKDIR /home/builder/dfu-utils
